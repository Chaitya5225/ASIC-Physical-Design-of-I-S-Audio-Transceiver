module i2s_tx (clk,
 ...
 sky130_fd_sc_hd__inv_2 _127_ (.A(net18),
    .Y(_069_));
 sky130_fd_sc_hd__nand4_1 _128_ (.A(\bit_counter[0] ),
    .B(\bit_counter[1] ),
    .C(\bit_counter[3] ),
    .D(\bit_counter[2] ),
    .Y(_070_));
 sky130_fd_sc_hd__or2_1 _129_ (.A(net36),
    .B(_070_),
    .X(_071_));
 sky130_fd_sc_hd__clkbuf_2 _130_ (.A(_071_),
    .X(_072_));
 sky130_fd_sc_hd__buf_2 _131_ (.A(_072_),
    .X(_073_));
 ...
 sky130_fd_sc_hd__nand2_2 _133_ (.A(net36),
    .B(_074_),
    .Y(_075_));
 sky130_fd_sc_hd__buf_2 _134_ (.A(_075_),
    .X(_076_));
 ...
 sky130_fd_sc_hd__dfrtp_1 _206_ (.CLK(_027_),
    ...
    .RESET_B(_026_),
    .Q(\bit_counter[1] ));
 sky130_fd_sc_hd__dfrtp_1 _207_ (.CLK(_029_),
    .D(_019_),
    .RESET_B(_028_),
    .Q(\bit_counter[2] ));
 sky130_fd_sc_hd__dfrtp_1 _208_ (.CLK(_031_),
    ...
    .RESET_B(_030_),
    .Q(\bit_counter[3] ));
 sky130_fd_sc_hd__dfrtp_1 _209_ (.CLK(_033_),
    .D(_021_),
    .RESET_B(_032_),
    .Q(net36));
 ...
 sky130_fd_sc_hd__buf_1 input4 (.A(left_data[12]),
    .X(net4));
 sky130_fd_sc_hd__clkbuf_1 input5 (.A(left_data[13]),
    .X(net5));
 ...
 sky130_fd_sc_hd__clkbuf_2 input17 (.A(reset),
    .X(net17));
 sky130_fd_sc_hd__clkbuf_1 input18 (.A(right_data[0]),
    .X(net18));
 ...
 sky130_fd_sc_hd__buf_1 input27 (.A(right_data[3]),
    .X(net27));
 sky130_fd_sc_hd__clkbuf_1 input28 (.A(right_data[4]),
    .X(net28));
 ...
 sky130_fd_sc_hd__buf_1 input31 (.A(right_data[7]),
    .X(net31));
 sky130_fd_sc_hd__clkbuf_1 input32 (.A(right_data[8]),
    .X(net32));
